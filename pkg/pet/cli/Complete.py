...
# declaration
class Complete(pet.shells.command, family="pet.cli.complete"):
    """
    Assist with shell auto-completion
    """

    word = pet.properties.str()
    word.doc = "the word we are attempting to auto-complete"

    line = pet.properties.str()
    line.doc = "the partial command line"

    # administrative
    @pet.export(tip="generate completions candidates from a partial command line")
